                        ...
                        <Box mt={10}>
                            ...
                            <Box display="flex" mt={3}>
                                ...
                                <Box mr={7}>
                                    ...
                                    <LinearProgress sx={{ width: "400px", height: "10px", bgcolor: "#ebebeb" }} color='secondary' variant="determinate" value={progress1} />
                                </Box>
                                ...
                                <Box>
                                    ...
                                    <LinearProgress sx={{ width: "400px", height: "10px", bgcolor: "#ebebeb" }} color='secondary' variant="determinate" value={progress3} />
                                </Box>
                            </Box>
                            <Box display="flex" mt={5}>
                                ...
                                <Box mr={7}>
                                    ...
                                    <LinearProgress sx={{ width: "400px", height: "10px", bgcolor: "#ebebeb" }} color='secondary' variant="determinate" value={progress2} />
                                </Box>
                                ...
                                <Box>
                                    ...
                                    <LinearProgress sx={{ width: "400px", height: "10px", bgcolor: "#ebebeb" }} color='secondary' variant="determinate" value={progress4} />
                                </Box>
                            </Box>
